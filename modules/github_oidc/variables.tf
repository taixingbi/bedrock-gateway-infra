...
variable "github_repo" {
  description = "Repository name this module's roles trust, e.g. \"bedrock-gateway-app\". One module call = one repo; call this module once per repo that needs OIDC roles."
  type        = string
}
